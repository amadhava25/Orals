...
\begin{itemize}
	...
	i.e., 
		\begin{equation*}
			E_{+}(t, x) = -\frac{\pi^{\frac{1-n}{2}}}{2}\chi_{\{t \geq 0\}}\frac{1}{\Gamma(\frac{3 - n}{2})^{\frac{n - 1}{2}}}\frac{1}{(t^{2} - |x|^{2})^{\frac{n- 1}{2}}}\chi_{\{|x| \leq t\}},
		\end{equation*} 
	...
	\end{equation*}
	(5) can be used to understand pointwise decay estimates of solutions. 
\end{itemize}
